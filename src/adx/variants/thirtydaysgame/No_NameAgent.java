...
public class No_NameAgent extends ThirtyDaysThirtyCampaignsAgent {

  public No_NameAgent(String host, int port) {
    super(host, port);
  }
...
//      return new ThirtyDaysBidBundle(day, c.getId(), Math.max(100,c.getBudget()), bidEntries);
  ...
  public static void main(String[] args) {
	  No_NameAgent agent = new No_NameAgent("localhost", 9898);
